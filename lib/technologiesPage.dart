...
class myTSearch extends SearchDelegate{
  ...
  ValueNotifier<bool> tSearchNavigation = ValueNotifier(false);
      ...
      child: ListView.builder(
          ...
          itemBuilder: (bc4, index){
            ...
            return ValueListenableBuilder<bool>(
              valueListenable: tSearchNavigation,
              builder: (context, tSearch, child){
                return AbsorbPointer(
                absorbing: tSearch,
                  child: ListTile(
                  title: Text("${myResult[0]}\nBy: ${myResult[1]}"),
                  onTap: () async{
                    if(tSearchNavigation.value){
                      return;
                    }

                    tSearchNavigation.value = true;
...
class technologiesPageState extends State<technologiesPage> with RouteAware{
              ...
              itemBuilder: (context, index){
                return Column(
                  children: <Widget>[
                    ...
                    index == mySublistsTechnologies[theCurrentPageTechnologies].length - 1? Container(
                      height: MediaQuery.of(context).size.height * 0.015625,
                    ):
                    Container(),
                  ],
...
class technologiesThreadContent extends State<technologiesThreadsPage> with RouteAware{
  ...
  Document buildMyDocumentFromTThreadContent(String myRawContent){
    try{
  ...
  Document buildMyDocumentFromTReplyContent(String myRawContent){
    try{
      return Document.fromJson(jsonDecode(myRawContent));
    }
    catch (e){
                    ...
                    children: <Widget>[
                      ...
                      Column(
                        children: <Widget>[
                                    ...
                                    Theme(
                                      ...
                                      child: QuillEditor(
                                        controller: QuillController(
                                          document: buildMyDocumentFromTReplyContent(mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["theOriginalReplyInfo"]["replyContent"].toString()),
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Theme(
                                        ...
                                        child: QuillEditor(
                                          controller: QuillController(
                                            document: buildMyDocumentFromTReplyContent(mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["replyContent"].toString()),
                                            selection: TextSelection.collapsed(offset: 0),
                                            readOnly: true,
                                          ),
                                          focusNode: FocusNode(),
                                      ...
                                      Text.rich(
                                        TextSpan(
                                          style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal),
                                          text: "\nPosted on: ${firebaseDesktopHelper.formatMyTimestamp(mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["time"].toString())}\nPosted by: ",
                                          children: <TextSpan>[
                                            TextSpan(
                                                style: TextStyle(color: Colors.blue, decoration: TextDecoration.underline, decorationColor: Colors.blue, fontWeight: FontWeight.normal),
                                      ...
                                      Text.rich(
                                        TextSpan(
                                            ...
                                            recognizer: TapGestureRecognizer()..onTap = () async {
                                              ...
                                              final myParentThread = await FirebaseFirestore.instance.collection("Technologies").where("threadId", isEqualTo: int.tryParse(threadID)).get();
                                              ...
                                              final myReportedReply = await FirebaseFirestore.instance.collection("Technologies").doc(myParentThreadDocName).collection("Replies").where("time", isEqualTo: mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["time"]).get();

                                              print("The number of matches: ${myReportedReply.docs.length}");

                                              if(myReportedReply.docs.isEmpty){
                                                print("Could not find reply with the reply time of ${mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["time"].toString()}");
                                                return;
                                              }
                                                          ...
                                                          TextButton(
                                                              ...
                                                              onPressed: () async{
                                                                if(!(myMain.whitespaceChecker(reportReplyController.text)) && reportReplyController.text != ""){
                                                                  ...
                                                                  sendAnEmail("starexpedition.theapp@gmail.com", "Reply reported: ", "Hi Star Expedition,<br><br>The reply from the Technologies subforum thread ${threadTitleT} with this document ID got reported: ${myReportedReplyDocName}.<br><br>Reply content: ${mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["replyContent"].toString()}<br>Reply time: ${mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["time"].toString()}<br>Reply author: ${mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies][index]["replier"].toString()}<br><br>Reason it got reported: ${reportReplyController.text}<br><br>Best,<br>Star Expedition");
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async{
                                ...
                                if(firebaseDesktopHelper.onDesktop){
                                  ...
                                  myDocT = theDocT.firstWhere((myThreadId) => myThreadId["threadId"] == int.parse(threadID), orElse: () => <String, dynamic>{})["docId"];
                          ...
                          index == mySublistsTechnologiesThreadReplies[theCurrentPageTechnologiesThreadReplies].length - 1? Container(
                            height: MediaQuery.of(context).size.height * 0.015625,
                          ):
                          Container(),
                        ]
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Theme(
                          ...
                          child: QuillEditor(
                            controller: QuillController(
                              document: buildMyDocumentFromTThreadContent(threadContentT),
                              selection: TextSelection.collapsed(offset: 0),
                              readOnly: true,
                            ),
                            focusNode: FocusNode(),
                        ...
                        Text.rich(
                          TextSpan(
                              ...
                              recognizer: TapGestureRecognizer()..onTap = () async {
                                ...
                                //Getting the information of a thread based on its ID:
                                final myReportedThread = await FirebaseFirestore.instance.collection("Technologies").where("threadId", isEqualTo: int.tryParse(threadID)).get();
                                            ...
                                            TextButton(
                                                ...
                                                onPressed: () async{
                                                  if(!(myMain.whitespaceChecker(reportThreadController.text)) && reportThreadController.text != ""){
                                                    ...
                                                    sendAnEmail("starexpedition.theapp@gmail.com", "Thread reported: ", "Hi Star Expedition,<br><br>The thread from the Technologies subforum with this document ID got reported: ${myReportedThreadDocName}.<br><br>Thread name: ${threadTitleT}<br>Thread content: ${threadContentT}<br>Thread author: ${threadAuthorT}<br><br>Reason it got reported: ${reportThreadController.text}<br><br>Best,<br>Star Expedition");
