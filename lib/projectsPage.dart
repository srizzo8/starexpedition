...
class myPSearch extends SearchDelegate{
  ...
  ValueNotifier<bool> pSearchNavigation = ValueNotifier(false);
      ...
      child: ListView.builder(
          ...
          itemBuilder: (bc4, index){
            ...
            return ValueListenableBuilder<bool>(
              valueListenable: pSearchNavigation,
              builder: (context, pSearch, child){
                return AbsorbPointer(
                  absorbing: pSearch,
                  child: ListTile(
                  title: Text("${myResult[0]}\nBy: ${myResult[1]}"),
                  onTap: () async{
                    if(pSearchNavigation.value){
                      return;
                    }

                    pSearchNavigation.value = true;
                                            ...
                                            TextSpan(
                                                ...
                                                recognizer: TapGestureRecognizer()..onTap = () async {
                                                  ...
                                                  if(firebaseDesktopHelper.onDesktop){
                                                    ...
                                                    theUsersData = projectsNameData.firstWhere((myUser) => myUser["usernameLowercased"].toString() == mySublistsProjects[theCurrentPage][index]["poster"].toString().toLowerCase(), orElse: () => <String, dynamic>{});
                                                  }
                                                  else{
                                                  ...
                                                  if(theUsersData?.isEmpty ?? true){
                                                    ...
                                                    theUsernameResult = mySublistsProjects[theCurrentPage][index]["poster"].toString();
                                                    fromPPage = true;
                  ...
                  children: <Widget>[
                    ...
                    Column(
                        children: <Widget>[
                                        ...
                                        Text.rich(
                                          TextSpan(
                                              ...
                                              recognizer: TapGestureRecognizer()..onTap = () async {
                                                ...
                                                final myParentThread = await FirebaseFirestore.instance.collection("Projects").where("threadId", isEqualTo: int.tryParse(threadID)).get();
                                                ...
                                                final myReportedReply = await FirebaseFirestore.instance.collection("Projects").doc(myParentThreadDocName).collection("Replies").where("time", isEqualTo: mySublistsProjectsThreadReplies[theCurrentPageProjectsThreadReplies][index]["time"]).get();

                                                print("The number of matches: ${myReportedReply.docs.length}");

                                                if(myReportedReply.docs.isEmpty){
                                                  print("Could not find reply with the reply time of ${mySublistsProjectsThreadReplies[theCurrentPageProjectsThreadReplies][index]["time"].toString()}");
                                                  return;
                                                }
                                                            ...
                                                            TextButton(
                                                                ...
                                                                onPressed: () async{
                                                                  if(!(myMain.whitespaceChecker(reportReplyController.text)) && reportReplyController.text != ""){
                                                                    ...
                                                                    sendAnEmail("starexpedition.theapp@gmail.com", "Reply reported: ", "Hi Star Expedition,<br><br>The reply from the Projects subforum thread ${threadTitleP} with this document ID got reported: ${myReportedReplyDocName}.<br><br>Reply content: ${mySublistsProjectsThreadReplies[theCurrentPageProjectsThreadReplies][index]["replyContent"].toString()}<br>Reply time: ${mySublistsProjectsThreadReplies[theCurrentPageProjectsThreadReplies][index]["time"].toString()}<br>Reply author: ${mySublistsProjectsThreadReplies[theCurrentPageProjectsThreadReplies][index]["replier"].toString()}<br><br>Reason it got reported: ${reportReplyController.text}<br><br>Best,<br>Star Expedition");
                          ...
                          index == mySublistsProjectsThreadReplies[theCurrentPageProjectsThreadReplies].length - 1? Container(
                            height: MediaQuery.of(context).size.height * 0.015625,
                          ):
                          Container(),
                        ]
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                ...
                                if(firebaseDesktopHelper.onDesktop){
                                  ...
                                  var matchingReply = thePThreadsReplies.firstWhere((myDoc) => myDoc["time"] == replyToReplyTimeP, orElse: () => <String, dynamic>{});
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            color: Colors.white,
            onPressed: () =>{
              print("We're going backwards. This is the depth: ${projectsNavigationDepth}"),
                              ...
                              TextSpan(
                                ...
                                TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()..onTap = () async {
                                    ...
                                    if(firebaseDesktopHelper.onDesktop){
                                      projectsNameData = await firebaseDesktopHelper.getFirestoreCollection("User");
                                      theUsersData = projectsNameData.firstWhere((myUser) => myUser["usernameLowercased"].toString() == threadAuthorP.toLowerCase(), orElse: () => <String, dynamic>{});
                                    }
                                    else{
                                    ...
                                    if(theUsersData?.isEmpty ?? true){
                                      ...
                                      theUsernameResult = threadAuthorP;
                                      fromPThread = true;
                                      Navigator.push(context, MaterialPageRoute(builder: (BuildContext context) => userProfileInOtherUsersPerspective())).then((_){
                                        if(mounted){
                                          setState(() => clickUsername = false);
                            ...
                            Text.rich(
                              TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()..onTap = () async {
                                    ...
                                    //Getting the information of a thread based on its ID:
                                    final myReportedThread = await FirebaseFirestore.instance.collection("Projects").where("threadId", isEqualTo: int.tryParse(threadID)).get();
                                                ...
                                                TextButton(
                                                    ...
                                                    onPressed: () async{
                                                      if(!(myMain.whitespaceChecker(reportThreadController.text)) && reportThreadController.text != ""){
                                                        ...
                                                        sendAnEmail("starexpedition.theapp@gmail.com", "Thread reported: ", "Hi Star Expedition,<br><br>The thread from the Projects subforum with this document ID got reported: ${myReportedThreadDocName}.<br><br>Thread name: ${threadTitleP}<br>Thread content: ${threadContentP}<br>Thread author: ${threadAuthorP}<br><br>Reason it got reported: ${reportThreadController.text}<br><br>Best,<br>Star Expedition");
