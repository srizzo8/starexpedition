        ...
        children: <Widget>[
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: subforumList.length + 1,
              itemBuilder: (context, index){
                if(index < subforumList.length){
                  return Column(
                    ...
                    children: <Widget>[
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async{
                            if(firebaseDesktopHelper.onDesktop){
                              ...
                              projectsThreadCount = projectsThreads.length;
                      ...
                      Container(
                        height: index < (subforumList.length - 1)? MediaQuery.of(context).size.height * 0.02 : 0,
                      ),
                    ],
                  );
                }
