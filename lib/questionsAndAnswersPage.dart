...
class myQaaSearch extends SearchDelegate{
  ...
  ValueNotifier<bool> qaaSearchNavigation = ValueNotifier(false);
      ...
      child: ListView.builder(
          ...
          itemBuilder: (bc4, index){
            ...
            return ValueListenableBuilder<bool>(
              valueListenable: qaaSearchNavigation,
              builder: (context, qaaSearch, child){
                return AbsorbPointer(
                absorbing: qaaSearch,
                  child: ListTile(
                  title: Text("${myResult[0]}\nBy: ${myResult[1]}"),
                  onTap: () async{
                    if(qaaSearchNavigation.value){
                      return;
                    }

                    qaaSearchNavigation.value = true;
                    ...
                    qaaSearchNavigation.value = false;
                  }
                )
              );
            }
...
class questionsAndAnswersThreadContent extends State<questionsAndAnswersThreadsPage> with RouteAware{
  ...
  Document buildMyDocumentFromQaaThreadContent(String myRawContent){
    try{
  ...
  Document buildMyDocumentFromQaaReplyContent(String myRawContent){
    try{
      return Document.fromJson(jsonDecode(myRawContent));
    }
    catch (e){
                                      ...
                                      Theme(
                                        ...
                                        child: QuillEditor(
                                          controller: QuillController(
                                            document: buildMyDocumentFromQaaReplyContent(mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["theOriginalReplyInfo"]["replyContent"].toString()),
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Theme(
                                          ...
                                          child: QuillEditor(
                                            controller: QuillController(
                                              document: buildMyDocumentFromQaaReplyContent(mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["replyContent"].toString()),
                                              selection: TextSelection.collapsed(offset: 0),
                                              readOnly: true,
                                            ),
                                            focusNode: FocusNode(),
                                        ...
                                        Text.rich(
                                          TextSpan(
                                            style: TextStyle(color: Colors.black, fontWeight: FontWeight.normal),
                                            text: "\nPosted on: ${firebaseDesktopHelper.formatMyTimestamp(mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["time"].toString())}\nPosted by: ",
                                            children: <TextSpan>[
                                              TextSpan(
                                                  style: TextStyle(color: Colors.blue, decoration: TextDecoration.underline, decorationColor: Colors.blue, fontWeight: FontWeight.normal),
                                        ...
                                        Text.rich(
                                          TextSpan(
                                              ...
                                              recognizer: TapGestureRecognizer()..onTap = () async {
                                                ...
                                                final myParentThread = await FirebaseFirestore.instance.collection("Questions_And_Answers").where("threadId", isEqualTo: int.tryParse(threadID)).get();
                                                ...
                                                final myReportedReply = await FirebaseFirestore.instance.collection("Questions_And_Answers").doc(myParentThreadDocName).collection("Replies").where("time", isEqualTo: mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["time"]).get();

                                                print("The number of matches: ${myReportedReply.docs.length}");

                                                if(myReportedReply.docs.isEmpty){
                                                  print("Could not find reply with the reply time of ${mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["time"].toString()}");
                                                  return;
                                                }
                                                            ...
                                                            TextButton(
                                                                ...
                                                                onPressed: () async{
                                                                  if(!(myMain.whitespaceChecker(reportReplyController.text)) && reportReplyController.text != ""){
                                                                    ...
                                                                    sendAnEmail("starexpedition.theapp@gmail.com", "Reply reported: ", "Hi Star Expedition,<br><br>The reply from the Questions and Answers subforum thread ${threadTitleQaa} with this document ID got reported: ${myReportedReplyDocName}.<br><br>Reply content: ${mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["replyContent"].toString()}<br>Reply time: ${mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["time"].toString()}<br>Reply author: ${mySublistsQaaThreadReplies[theCurrentPageQaaThreadReplies][index]["replier"].toString()}<br><br>Reason it got reported: ${reportReplyController.text}<br><br>Best,<br>Star Expedition");
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Theme(
                              ...
                              child: QuillEditor(
                                controller: QuillController(
                                  document: buildMyDocumentFromQaaThreadContent(threadContentQaa),
                                  selection: TextSelection.collapsed(offset: 0),
                                  readOnly: true,
                                ),
                                focusNode: FocusNode(),
                            ...
                            Text.rich(
                              TextSpan(
                                  ...
                                  recognizer: TapGestureRecognizer()..onTap = () async {
                                    ...
                                    //Getting the information of a thread based on its ID:
                                    final myReportedThread = await FirebaseFirestore.instance.collection("Questions_And_Answers").where("threadId", isEqualTo: int.tryParse(threadID)).get();
                                                ...
                                                TextButton(
                                                    ...
                                                    onPressed: () async{
                                                      if(!(myMain.whitespaceChecker(reportThreadController.text)) && reportThreadController.text != ""){
                                                        ...
                                                        sendAnEmail("starexpedition.theapp@gmail.com", "Thread reported: ", "Hi Star Expedition,<br><br>The thread from the Questions and Answers subforum with this document ID got reported: ${myReportedThreadDocName}.<br><br>Thread name: ${threadTitleQaa}<br>Thread content: ${threadContentQaa}<br>Thread author: ${threadAuthorQaa}<br><br>Reason it got reported: ${reportThreadController.text}<br><br>Best,<br>Star Expedition");
